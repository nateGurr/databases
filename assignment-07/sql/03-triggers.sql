...
-- 
-- Trigger Function: manufacturing.audit_parts_changes()
-- Trigger: trg_audit_parts (AFTER INSERT OR UPDATE OR DELETE)
-- 
-- Requirements:
--   - Log to manufacturing.audit_log table
...
-- 
-- Trigger Function: manufacturing.track_order_status()
-- Trigger: trg_order_status_history (AFTER UPDATE ON production_orders)
-- 
-- Requirements:
--   - Only fire if status actually changed
--   - Log to manufacturing.order_status_history table
...
-- 
-- Trigger Function: manufacturing.prevent_active_machine_delete()
...
-- 
-- Trigger Function: manufacturing.update_timestamp()
-- 
-- Requirements:
